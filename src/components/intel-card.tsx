    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 rounded-lg bg-purple-500/10 border border-purple-500/20">
          <div className="text-[10px] uppercase tracking-wider text-purple-400 mb-1">Tines Fit</div>
          <p className="text-xs text-slate-300">{intel.tines_fit}</p>
        </div>
        <div className="p-3 rounded-lg bg-violet-500/10 border border-violet-500/20">
          <div className="text-[10px] uppercase tracking-wider text-violet-400 mb-1">Security Challenge</div>
            ...
            {intel.target_contacts.map((c, i) => (
              <div key={i} className="p-2 rounded bg-white/5 text-xs">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 mt-1 text-purple-400 hover:text-purple-300"
                >
      ...
      <div className="p-3 rounded-lg bg-white/5 border border-white/10">
        <div className="flex items-center justify-between mb-2">
          ...
          <button onClick={copyOutreach} className="text-xs text-purple-400 hover:text-purple-300 flex items-center gap-1">
